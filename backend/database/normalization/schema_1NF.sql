...
CREATE TABLE orders (
  ...
  -- quantities VARCHAR2(2000) NOT NULL, all 3 removed because they contained lists and not atomic values
...
CREATE TABLE order_items (  --new table
...
-- removed items, quantities, prices lists from the orders table and created a new table order_items