...
CREATE TABLE product_categories (
  ...
  --category_name VARCHAR2(20) NOT NULL, (removed as it was only dependent upon category id and moved to another table) 
  created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE cart_items (
  user_id NUMBER NOT NULL,
  product_id VARCHAR2(20) NOT NULL,
  -- product_name VARCHAR2(255) (removed as its alredy was in products and was also dependent upon only product_id)
...
CREATE TABLE order_items (
  ...
  product_id VARCHAR2(20) NOT NULL,
  quantity NUMBER(4) NOT NULL,
  -- price NUMBER(10) NOT NULL, removed as this was only dependent on product id and was already present in products table
