...
CREATE TABLE products (
  ...
  CONSTRAINT check_unit_by_sale CHECK ((sale_type = 'variable' AND unit IN ('kg', 'l', 'g', 'ml')) OR (sale_type = 'fixed' AND unit = 'unit')),
  CONSTRAINT check_unit_weight_null CHECK ((sale_type = 'fixed') OR (sale_type = 'variable' AND unit_weight IS NULL))
);
